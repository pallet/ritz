...
(deftest connection-info-test
  (test-utils/eval-for-emacs-test
   ...
   #"0000[ab][0-9a-f]\(:return \(:ok \(:pid \"\d+\" :style :spawn :lisp-implementation \(:type \"Clojure\" :name \"clojure\" :version \"1.[23].[0-1](-[a-zA-Z]+)?\"\) :package \(:name \"user\" :prompt \"user\"\) :version \"20101113\"\)\) 1\)"))
